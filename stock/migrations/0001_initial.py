    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('picking_diff_type', models.CharField(max_length=255, verbose_name='作业类型特殊编码')),
                ('create_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='创建时间')),
                ('create_date', models.DateField(default=datetime.datetime.today, verbose_name='创建日期')),
                ('expect_date', models.DateField(default=stock.models.toady_add_seven, verbose_name='预计完成日期')),
                ('done_date', models.DateField(default=stock.models.toady_add_seven, verbose_name='完成日期')),
                ('is_active', models.BooleanField(default=True)),
